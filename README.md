...
## 🧪 Portfolio — Multi-Agent Banking RAG

Most of my professional multi-agent/AI work sits in private company repositories, so it isn't visible on this profile. I built this project specifically **as a public portfolio piece** — an open, from-scratch reference implementation of the same architecture patterns: LangGraph orchestration, hybrid RAG (vector + BM25), FastMCP tool-calling, rule-based NER/intent recognition, and a policy guardrail layer, wired around a fictional banking-support domain.

[**ebraronuk/multi-agent-banking-rag**](https://github.com/ebraronuk/multi-agent-banking-rag) — LangGraph · FastMCP · FastAPI · Chroma · Docker · Kubernetes
...
| ✈️ [**engine-performance-analyzer**](https://github.com/ebraronuk/engine-performance-analyzer) | Aircraft engine performance & degradation-trend analysis | Python · MATLAB |
